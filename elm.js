...
var $author$project$Update$changeAndSave = F2(
	function (msg, model) {
...
var $author$project$ExtractionSum$sum = function (numericExtractions) {
	return A2(
		$rundis$elm_bootstrap$Bootstrap$Grid$col,
		_List_Nil,
		_List_fromArray(
...
var $author$project$ExtractionSum$time = function (now) {
	return A2(
		$rundis$elm_bootstrap$Bootstrap$Grid$col,
		_List_fromArray(
			[
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$oneOf(
		_List_fromArray(
			...
			])))({"versions":{"elm":"0.19.1"},"types":{"message":"Msg.Msg","aliases":{"Extraction.Extraction":{"args":[],"type":"{ date : String.String, amount : String.String }"}},"unions":{"Msg.Msg":{"args":[],"tags":{"ExtractionListMsg":["Msg.ModelMsgType"],"ExtractionNewMsg":["Msg.ViewMsgType"],"OnTime":["Time.Posix"]}},"Msg.ModelMsgType":{"args":[],"tags":{"Add":["Extraction.Extraction"],"Remove":["Extraction.Extraction"],"Load":["List.List Extraction.Extraction"]}},"Time.Posix":{"args":[],"tags":{"Posix":["Basics.Int"]}},"Msg.ViewMsgType":{"args":[],"tags":{"Date":["String.String"],"Amount":["String.String"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"List.List":{"args":["a"],"tags":{}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));