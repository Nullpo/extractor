...
var $author$project$Extraction$extractionDecoder = A3(
...
var $author$project$ExtractionSumComponent$changeAmountPerTake = function (value) {
	var maybeInt = value.a;
	if (maybeInt.$ === 'Just') {
		var a = maybeInt.a;
		return a;
	} else {
...
var $author$project$Update$cleanError = function (model) {
	return _Utils_update(
		model,
		{error: $elm$core$Maybe$Nothing});
};
var $author$project$Update$nocmd = function (model) {
...
var $author$project$Ports$stateEncoder = function (model) {
	return _List_fromArray(
		[
			...
			$elm$json$Json$Encode$int(model.expectedAmountPerTake))
		]);
};
...
var $author$project$Update$save = function (model) {
	var cmd = $author$project$Ports$saveState(model);
...
var $author$project$DateTimeUtils$toLocalTimezone = $waratuman$time_extra$Time$Extra$addHours(-3);
...
var $author$project$ExtractionListModel$excludeFrom = F2(
	function (extractions, extraction) {
		return $elm$core$List$filter(
			$author$project$ExtractionListModel$excludeSameExtraction(extraction))(extractions);
	});
var $author$project$ExtractionListModel$removeExtraction = F2(
	function (extractions, extraction) {
	...
	function (msg, model) {
		switch (msg.$) {
			case 'Add':
				...
				return A2($author$project$ExtractionListModel$addExtraction, model, extraction);
			case 'Remove':
				var extraction = msg.a;
				return A2($author$project$ExtractionListModel$removeExtraction, model, extraction);
			default:
				var extractions = msg.a;
				return extractions;
		}
	});
var $author$project$NewExtractionComponent$updateNewExtraction = F2(
	function (msg, model) {
		if (msg.$ === 'Date') {
			var date = msg.a;
			return {amount: model.amount, date: date};
		} else {
			var amount = msg.a;
			return {amount: amount, date: model.date};
		}
	});
	...
	function (msg, model) {
		switch (msg.$) {
			case 'ExtractionListMsg':
				var modelMsg = msg.a;
				return A2($elm$core$Basics$composeL, $author$project$Update$save, $author$project$Update$cleanError)(
					_Utils_update(
						model,
						{
							extractions: A2($author$project$ExtractionListModel$updateExtractionList, modelMsg, model.extractions)
						}));
			case 'ExtractionNewMsg':
				var viewMsg = msg.a;
				return A2($elm$core$Basics$composeL, $author$project$Update$nocmd, $author$project$Update$cleanError)(
					_Utils_update(
						model,
						{
			...
			default:
				...
				return A2($elm$core$Basics$composeL, $author$project$Update$save, $author$project$Update$cleanError)(
					_Utils_update(
						model,
						{
							expectedAmountPerTake: $author$project$ExtractionSumComponent$changeAmountPerTake(sum)
						}));
		}
	});
var $author$project$Msg$ExtractionListMsg = function (a) {
	return {$: 'ExtractionListMsg', a: a};
};
var $author$project$Msg$Add = function (a) {
	return {$: 'Add', a: a};
};
var $author$project$ExtractionListModel$addToModel = $author$project$Msg$Add;
...
var $author$project$Msg$Remove = function (a) {
	return {$: 'Remove', a: a};
};
var $author$project$ExtractionListModel$removeFromModel = $author$project$Msg$Remove;
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text(extraction.amount)
						]))
				])),
			A2(
			$rundis$elm_bootstrap$Bootstrap$Table$td,
...
var $author$project$BootstrapUtils$footerStyle = _List_fromArray(
	[
		...
		A2($elm$html$Html$Attributes$style, 'border-top', '#C0C0C0 solid 2px')
	]);
...
var $author$project$BootstrapUtils$footer = function (fn) {
	return A2(
		$rundis$elm_bootstrap$Bootstrap$Grid$container,
		$author$project$BootstrapUtils$footerStyle,
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						A2($rundis$elm_bootstrap$Bootstrap$Grid$col, _List_Nil, fn)
					]))
			]));
};
...
var $author$project$Msg$Amount = function (a) {
	return {$: 'Amount', a: a};
};
var $author$project$NewExtractionComponent$amountView = $author$project$Msg$Amount;
...
var $author$project$NewExtractionComponent$amountComponent = $rundis$elm_bootstrap$Bootstrap$Form$Input$number(
	_List_fromArray(
		[
			$rundis$elm_bootstrap$Bootstrap$Form$Input$onInput(
			A2($elm$core$Basics$composeL, $author$project$Msg$ExtractionNewMsg, $author$project$NewExtractionComponent$amountView)),
			$rundis$elm_bootstrap$Bootstrap$Form$Input$placeholder('mililitros')
		]));
var $author$project$Msg$Date = function (a) {
	return {$: 'Date', a: a};
};
var $author$project$NewExtractionComponent$dateView = $author$project$Msg$Date;
var $rundis$elm_bootstrap$Bootstrap$Form$Input$DatetimeLocal = {$: 'DatetimeLocal'};
var $rundis$elm_bootstrap$Bootstrap$Form$Input$datetimeLocal = $rundis$elm_bootstrap$Bootstrap$Form$Input$input($rundis$elm_bootstrap$Bootstrap$Form$Input$DatetimeLocal);
var $author$project$NewExtractionComponent$dateComponent = $rundis$elm_bootstrap$Bootstrap$Form$Input$datetimeLocal(
	_List_fromArray(
		[
			$rundis$elm_bootstrap$Bootstrap$Form$Input$onInput(
			A2($elm$core$Basics$composeL, $author$project$Msg$ExtractionNewMsg, $author$project$NewExtractionComponent$dateView)),
			$rundis$elm_bootstrap$Bootstrap$Form$Input$placeholder('fecha')
		]));
...
var $author$project$DateTimeUtils$toHtmlDateTime = A2($danhandrea$elm_date_format$DateFormat$format, 'yyyy-MM-ddTHH:mm', $elm$time$Time$utc);
var $author$project$View$onCreate20MinutesBefore = function (model) {
	var newDate = A2(
		$elm$core$Basics$composeL,
		$author$project$DateTimeUtils$toHtmlDateTime,
...
var $author$project$ExtractionSumComponent$amount = function (x) {
	return x.amount;
};
...
var $author$project$BootstrapUtils$col = A2(
	$elm$core$Basics$composeL,
	$rundis$elm_bootstrap$Bootstrap$Grid$col(_List_Nil),
	$elm$core$List$singleton);
var $author$project$Msg$ExtractionSumMsg = function (a) {
	return {$: 'ExtractionSumMsg', a: a};
};
var $author$project$Msg$Change = function (a) {
	return {$: 'Change', a: a};
};
var $author$project$ExtractionSumComponent$changeExpectedAmount = $author$project$Msg$Change;
...
var $author$project$ExtractionSumComponent$expectedComponent = function (value) {
	return A2($elm$core$Basics$composeL, $author$project$BootstrapUtils$col, $rundis$elm_bootstrap$Bootstrap$Form$Input$number)(
		_List_fromArray(
			[
				$rundis$elm_bootstrap$Bootstrap$Form$Input$onInput(
				A2(
					$elm$core$Basics$composeL,
					A2($elm$core$Basics$composeL, $author$project$Msg$ExtractionSumMsg, $author$project$ExtractionSumComponent$changeExpectedAmount),
					$elm$core$String$toInt)),
				$rundis$elm_bootstrap$Bootstrap$Form$Input$placeholder('ml x toma'),
...
var $author$project$ExtractionUtils$isExtractionFromThisDay = F2(
...
var $author$project$ExtractionSumComponent$totalExpectedComponent = A2(
	...
	A2(
		...
		A2(
			$elm$core$Basics$composeL,
			$elm$html$Html$text,
			$elm$core$Basics$append('x 8 = ')),
		$elm$core$String$fromInt),
	$elm$core$Basics$mul(8));
var $author$project$ExtractionSumComponent$sumLastDay = F3(
	function (now, extractions, expected) {
		...
		var numericExtractions = A2(
			$elm$core$List$filterMap,
			A2($elm$core$Basics$composeL, $elm$core$String$toInt, $author$project$ExtractionSumComponent$amount),
			okExtractions);
		return _List_fromArray(
			[
				$author$project$ExtractionSumComponent$sumComponent(numericExtractions),
			...
			[
				...
				_List_fromArray(
					[
						...
						A2($elm$html$Html$Attributes$style, 'padding-bottom', '12em')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('-- Fin de la lista --')
									]))
							]))
					])),
				$author$project$BootstrapUtils$footer(
				A2(
